 ...
 *** 							ajax functions
 ------------------------------------------------------------
 */
function send_invoice(txn_id) {
    $.ajax({
        type: "POST",
        url: site_url() + "/admin/transactions/send_invoice",
        data: {txn_id: txn_id},
...
$(document).ready(function () {
    $(".edit_review").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: site_url() + "/admin/reviews/edit_review",
            data: {review_id: review_id},
            success: function (data)
            {
                $(".edit_review_form textarea").val(data);
                $(".edit_review_form input[name=review_id]").val(review_id);
