...
@stop
@section('content')
{!! Form::open(array('class' => 'form-horizontal', 'id' => 'packages-form','files' => 'true', 'url' => '/admin/SmsPackage')) !!}
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <label class="col-sm-2 control-label" for="limit">No Of SMS</label>
            <div class="col-sm-10">
