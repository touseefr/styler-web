...
<div class="content-toolbox">
    <ul id="toolbar-nav" class="nav nav-pills pull-right" style="margin:0">
        <li>
            <a href="{{ Url('admin/ListingPackage/New') }}" class="toolbar_btn" title="Create New Package">
...
<li class="active">Listing Packages</li>
@stop
...
<table class="table table-bordered table-hover table-striped">
    ...
    <tbody>
        ...
        @else
        <tr>
            <td colspan="6" style="text-align: center;">Listing Packages not Available</td>
        </tr>
        @endif
    </tbody>
</table>
