...
@section ('breadcrumbs')
    ...
    <li class="active"><a href="{{url('admin/access/users/deleted')}}">{{trans('menus.deleted_users')}}</a></li>
                    ...
                    <tr>
                        ...
                        <td>
                            @permission('undelete-users')
                                <a href="{{route('admin.access.user.restore', $user->id)}}" class="btn btn-xs btn-success mb-2" name="restore_user"><i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="{{ trans('crud.users.restore_user') }}"></i></a>
                            @endauth

                            @permission('permanently-delete-users')
                                <a href="{{route('admin.access.user.delete-permanently', $user->id)}}" class="btn btn-xs btn-danger mb-2" name="delete_user_perm"><i class="fa fa-times" data-toggle="tooltip" data-placement="top" title="{{ trans('crud.users.delete_permanently') }}"></i></a>
                            @endauth
                        </td>
                    </tr>
                @endforeach
