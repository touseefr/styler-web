...
@section('content')
    ...
    {!! Form::open(['route' => 'admin.access.roles.permissions.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) !!}
        ...
        <div class="well text-right">
          <a href="{!! route('admin.access.roles.permissions.index') !!}" class="btn btn-danger btn-md mr-2">{{ trans('strings.cancel_button') }}</a>
          <input type="submit" class="btn btn-primary btn-md mb-2" value="{{ trans('strings.save_button') }}" />
        </div><!--well-->
