...
<div class="box">
    ...
    <!-- /.box-header -->
    <div class="box-body">
        {!! Form::open(['url' => 'admin/subscription/plan/type/edit/'.$id, 'class' => 'form-horizontal planForm', 'role'
        => 'form', 'method' => 'post']) !!}
        <div class="row">
            <div class="col-md-10">
                <div class="form-group">
                    ...
                    !!}
                    <div class="col-lg-10">
                        {!! Form::text('txttitle', $plans['name'], ['class' => 'form-control', 'placeholder' =>
                        trans('plans.plan_fields.title')]) !!}
                    </div>
                </div>
                <!--form control-->
                    ...
                    <div class="col-lg-10">
                        <select id="ddlRole" name="ddlRole" class="form-control">
                            ...
                            <option value="<?php echo $role['id'] ?>"
                                <?php echo ($role['id'] == $plans['role_type']) ? 'selected="selected"' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="checkbox" id="cbFreePack" name="cbFreePack" class="form-check-input" value="isFree"
                            <?php echo ($plans['plan_type'] == 0) ? 'checked="checked"' : ''; ?> disabled="disabled" />
                    </div>
                </div>
                <div id="divPriceDiscount">
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="checkbox" id="includebooking" name="includebooking" class="form-check-input"
                                value="1" <?php echo ($plans['booking_type'] == 1) ? 'checked="checked"' : ''; ?>
                                disabled="disabled" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="checkbox" id="bestValue" name="bestValue" class="form-check-input" value="1"
                                <?php echo ($plans['top_circle_text'] == 1) ? 'checked="checked"' : ''; ?>
                                disabled="disabled" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <div class="row">
                                <div class="col-lg-4">
                                    Weekly
                                    <input type="number" name="Plan[week][Price]" class="form-control"
                                        id="txtPriceWeekly"
                                        value="<?php echo isset($plans['plan_detail']['week']['price']) ? $plans['plan_detail']['week']['price'] : ''; ?>"
                                        Placeholder="Weekly Price" disabled="disabled" />
                                </div>
                                <div class="col-lg-4">
                                    Monthly
                                    <input type="number" name="Plan[month][Price]" id="txtPriceMonthly"
                                        class="form-control"
                                        value="<?php echo isset($plans['plan_detail']['month']['price']) ? $plans['plan_detail']['month']['price'] : ''; ?>"
                                        Placeholder="Monthly Price" disabled="disabled" />
                                </div>
                                <div class="col-lg-4">
                                    Annualy
                                    <input type="number" name="Plan[year][Price]" id="txtPriceAnnually"
                                        value="<?php echo isset($plans['plan_detail']['year']['price']) ? $plans['plan_detail']['year']['price'] : ''; ?>"
                                        class="form-control" Placeholder="Annualy Price" disabled="disabled" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <div class="row">
                                <div class="col-lg-4">
                                    Annualy
                                    <input type="number" name="Plan[year][Discount]" class="form-control"
                                        id="txtAnnuallyDiscount"
                                        value="<?php echo isset($plans['plan_detail']['year']['discount'])?$plans['plan_detail']['year']['discount']:''; ?>"
                                        Placeholder="Annuly Discount" disabled="disabled" />
                                </div>
                                <div class="col-lg-4">
                                    <div id="divAnnualNetPrice" style="display: none">
                                        Net Price
                                        <input type="number" name="Plan[year][netPrice]" class="form-control"
                                            id="txtAnnualyNetPrice" readonly=""
                                            value="<?php echo isset($plans['plan_detail']['year']['price'])?$plans['plan_detail']['year']['price']:''; ?>" Placeholder="
                                            Net Price" disabled="disabled" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type='color' id="txtbgcolour" name='txtbgcolour' value="<?php echo isset($plans['bg_colour'])?$plans['bg_colour']:''; ?>" />
                        </div>
                    </div>
                    <!--form control-->
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="row" id="descriptionRow">
                            <?php
                            $items = json_decode($plans['template_description']);
                            ...
                            <div class="col-md-6 m-b-20 dragdrop" id="addRowDesc-<?php echo $key; ?>">
                                ...
                                <a class="btn-delete btn btn-xs btn-danger delete-descr-row float-right"
                                    style="margin-left: 15px;"><i class="fa fa-trash"></i></a>
                                <input type="checkbox" name="cbCheck[]" data-info='<?php echo $json_data; ?>'
                                    style="float: right;" value="<?php echo $value['inputValue']; ?>"
                                    <?php echo ($value['inputValue'] == 1) ? 'checked="checked"' : ''; ?>
                                    class="inputCbChange descData" />
                                <?php } else { ?>
                                <label><?php echo $value['text']; ?></label>
                                <a class="btn-delete btn btn-xs btn-danger delete-descr-row float-right"
                                    style="margin-left: 15px;"><i class="fa fa-trash"></i></a>
                                <input type="text" name="cbCheck[]" data-info='<?php echo $json_data; ?>'
                                    style="width: 82px;float: right;" value="<?php echo $value['inputValue']; ?>"
                                    class="inputTxtChange form-control descData" />
                                <?php } ?>
                            </div>
                            <?php }
                            ?>
        ...
        <div class="well text-right">
            <a href="{{url('admin/access/users')}}"
                class="btn btn-danger btn-md mr-2">{{ trans('strings.cancel_button') }}</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".savePlan", function () {
            ...
            $.ajax({
                url: '/admin/subscription/plan/type/edit/<?php echo $plans["id"];?>',
                type: 'POST',
                data: $.param(formData),
