<div>
    ...
    <a href="<?php echo env('APP_URL');?>">Home</a>
			<p><b>Dear Me!,</b></p>
			...
			<h4>Here’s a quick way to get you started:<h4>
                        ...
                        <p>Search for the best beauty business in your area. Read what others have to say about the business. Get new deals every day and contact as many providers as you like to learn more about their services. You can make a quick search <a href="">click here</a></p>                          
                        ...
                        <p>Ready to take Stylerzone for a spin? Sign in to your account now:<a href="">Login here</a></p>
                        <p>Got questions? Please contact us on Support@stylerzone.com.au and we will get back to you.</p>
                        <p>See you around!</p>
                        <p>Stylerzone Team</p>
                        <br />
                        <br />
                        <p>If you want to unsubscribe from Stylerzone, please <a href="">click here.</a></p>
                        <p>If this is not you and you would like to unsubscribe from Stylerzone, please <a href="">click here.</a></p>                                                
		</div>