...
<!--                                        <div  class="col-sm-4 col-padding-adjustment">
                                            <a data-toggle="tab" href="#classifieds" title="Classifieds" onclick="changeHomeTab('Classifieds', this)" class="btn-orange-1 tabBtn classifieds_btn">Classifieds</a>
                                        </div>                                        -->
                                        <div class="col-sm-4 col-padding-adjustment">
...
<!--                                        <div data-toggle="tab" class="col-sm-4 col-padding-adjustment" onclick="changeHomeTab('Business for sale', this)">
        ...
        <div class="row tab-content deals-listing">           
            <div id="deals" class="tab-pane fade in active">
                ...
                <div class="deals-footer">
                    <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                        <button onclick="window.open('/listingbycat?page=1&type=deal<?php echo (Request::is('profile'))?"&p_id=".$user_id:"" ?>','_self')" class="btn-yellow-1">View more</button>
                    </div>
                </div>
            </div>
            <div id="classifieds" class="tab-pane fade">
                ...
                <div class="deals-footer">
                    <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                        <button onclick="window.open('/listingbycat?page=1&type=classified<?php echo (Request::is('profile'))?"&p_id=".$user_id:"" ?>','_self')" class="btn-yellow-1">View more</button>
                    </div>
                </div>
            </div>
            ...
            <div id="jobs" class="tab-pane fade">
                ...
                <div class="deals-footer">
                    <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                        <button onclick="window.open('/listingbycat?page=1&type=job<?php echo (Request::is('profile'))?"&p_id=".$user_id:"" ?>','_self')" class="btn-yellow-1">View more</button>
                    </div>
                </div>
            </div>
            ...
            <div id="BusinessForSale" class="tab-pane fade">
                ...
                <div class="deals-footer">
                    <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                        <button onclick="window.open('/listingbycat?page=1&type=businessforsale<?php echo (Request::is('profile'))?"&p_id=".$user_id:"" ?>','_self')" class="btn-yellow-1">View more</button>
                    </div>
                </div>
            </div>
        </div>
