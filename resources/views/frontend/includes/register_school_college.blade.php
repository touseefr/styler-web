<form role="form" name="authCtrl.userRegister" novalidate="" ng-init="authCtrl.user.sub_newletter = 1" ng-submit="authCtrl.registerAccount()" ng-if="authCtrl.activeForm === 'school_college'">       
    <h3 style="margin-top: 30px;margin-bottom: 30px;">School / College</h3>
    ...
    <div class="row">
        <div class="col-xs-12 col-md-6">
            <div class="form-group" ng-class="{ 'has-error' : authCtrl.userRegister.business_name.$invalid && !authCtrl.userRegister.business_name.$pristine }">
                <input tabindex="1" type="text" placeholder="School / College Name" ng-model="authCtrl.user.business_name" name="business_name" required class="form-control" />
                <div ng-show="authCtrl.userRegister.business_name.$invalid && !authCtrl.userRegister.business_name.$pristine">
                    <p ng-show="authCtrl.userRegister.business_name.$error.required" class="help-block">Please enter school / college name</p>
                </div>
            </div>
            ...
            <div class="form-group" ng-class="{ 'has-error' : authCtrl.userRegister.email.$invalid && !authCtrl.userRegister.email.$pristine }">
                <input tabindex="5" type="text" placeholder="Email" ng-model="authCtrl.user.email" name="email" required ng-pattern='/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/' class="form-control" />
            ...
            <div class="form-group">
                <div class="select-postcode">
                    <select tabindex="9" class="businessType-select form-control" ng-model="authCtrl.user.hear_us" >
        ...
        <div class="col-xs-12 col-md-6">
            ...
            <div class="form-group" ng-class="{ 'has-error' : authCtrl.userRegister.contact_number.$invalid && !authCtrl.userRegister.contact_number.$pristine }">
                <input tabindex="4" type="text" placeholder="Contact Number" ng-model="authCtrl.user.contact_number" name="contact_number" class="form-control" required />
            ...
            <div class="terms form-group theme-color  mt-25">
                <input type="checkbox" name="terms_condition" ng-model="authCtrl.user.terms_condition"  style="display:none;" checked='checked' />Subscribe for Newsletter
                <span class="chkbox ml-10">
                    <input tabindex="12" type="checkbox" name="sub_newletter" ng-model="authCtrl.user.sub_newletter" value="1" ng-true-value="1" ng-false-value="0" />
                </span>&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
             <div class="terms form-group theme-color mt-25">
        ...
        <div class="col-md-12 mt-10">
            <!-- <div class="terms form-group theme-color col-md-12" >
                Do you have promo coupon?
                <span class="chkbox">
                    <input type="checkbox" name="sub_newletter" ng-model="authCtrl.havepromo" value="1" ng-true-value="1" ng-false-value="0" />
                </span>   
                <div class="terms form-group theme-color" ng-class="{ 'has-error' : authCtrl.couponerror == 1}" >
                    <span ng-if="authCtrl.havepromo"  >
                        <input type="text"  class="form-control" ng-model="authCtrl.user.promo_code" placeholder="Promo Code" name="promo_code" ng-keyup="authCtrl.couponerror = 0" />
            ...
            By clicking Register Account button you agree to our <a href="../termsandconditions">Terms and Conditions</a>, including our Cookie use
        </div>
        <div class="col-md-12">
            <button class="submit_btn"  ng-class="{diabledCls:authCtrl.userRegister.$invalid || loadingSpinner || authCtrl.couponerror == 1}" type="submit" data-ng-disabled="authCtrl.userRegister.$invalid || loadingSpinner || authCtrl.couponerror == 1">
