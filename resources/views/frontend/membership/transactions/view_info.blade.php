   ...
   <div class="container">
      <div class="row" style="padding-top: 80px;padding-bottom: 80px;">
         <div class="col-md-12">
            <div class="row">
               <div class="col-sm-12">
			   <h2 class="title-bar">Transaction Info: {{$txn_id}}</h2>
			   <div class="add-new-team-member text-right">	
					<a href="{{url('account/transactions')}}" class="btn btn-primary">Back</a>
				</div>
...
<div class="transaction-details">
						<div class="user-info boxess">
								<h3 class="title-bar"><strong>User Info</strong></h3>
						...
						<div class="txn-info boxess">
								<h3 class="title-bar"><strong>Transaction Info</strong></h3>
						...
						<div class="plan-info boxess">
								<h3 class="title-bar"><strong>Plan Info</strong></h3>
								...
								<table class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td><?php echo date(getenv('DATE_FORMATE'), strtotime($plan['purchased_date']));?></td>
										</tr>
										<tr>
											<td><b>Expiry date:</b></td>
											<td><?php echo date(getenv('DATE_FORMATE'), strtotime($plan['expired_date']));?></td>
										</tr>
										<tr>
											<td><b>Features:</b></td>
