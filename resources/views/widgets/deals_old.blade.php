...
<div class="create_list_inner home-listing list_padding">
    <div class="tab-content  dealsslider">        
                    ...
                    <div class="main_block">
                        <div class="item_image">
                            ...
                            <a href="{{ URL::to('/') }}/{{ 'profile?id='.$list -> user -> id}}">
                                ...
                                <img src="{{$list -> user -> profilepic['path'].'thumb_small_'.$list -> user -> profilepic['name']}}"
                        ...
                        <div class="content-block" onclick="javascript:window.open('/deals?id={{ $list->id }}', '_self')">
        ...
        if ($count == 2) {
            ...
            if (count($deals_array) == $odd_count) {
                echo "</div>";
            }
            $count++;
        }
