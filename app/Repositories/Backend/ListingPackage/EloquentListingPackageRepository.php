<?php namespace App\Repositories\Backend\ListingPackage;
 ...
 */
class EloquentListingPackageRepository implements ListingPackageContract {
	...
	public function findOrThrowException($id) {
		...
		return $package = ListingPackage::withTrashed()->find($id);
	...
	public function getpackagesPaginated($per_page, $status = 1, $order_by = 'id', $sort = 'asc') {
		return ListingPackage::orderBy($order_by, $sort)->paginate($per_page);
	}
	...
	public function getAllPackages($order_by = 'id', $sort = 'asc') {
		return ListingPackage::orderBy($order_by, $sort)->get();
	}
